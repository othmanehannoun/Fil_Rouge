  ...
  return (
        ...
        <>
              ...
              <Stack.Navigator>
                ...
                <Stack.Screen name="Dashboard" component={TabNav} options={{ title: 'Dashboard', headerTitleStyle: {fontWeight: 'bold'}}} />
                ...
                <Stack.Screen name="DashboardCnt" component={DashboardCnt} options={{ title: 'Dashboard', headerTitleStyle: {fontWeight: 'bold'}}} />
